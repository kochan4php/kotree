    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      ...
      <div className="relative z-10 max-w-md w-full">
        <div className="bg-white/10 rounded-3xl p-8 border border-white/20 shadow-2xl text-center">
          <div
            className="text-8xl font-bold bg-gradient-to-r from-pink-400 via-purple-400 to-blue-400 bg-clip-text text-transparent mb-4 animate-gradient bg-[length:400%_400%] drop-shadow-lg">
            404
          </div>

          <h1 className="text-2xl font-bold text-white mb-3">Halaman Tidak Ditemukan</h1>

          <p className="text-white/80 mb-8 leading-relaxed">Oops! Halaman yang Anda cari tidak dapat ditemukan. Mungkin
            halaman telah dipindahkan atau URL salah.</p>
