    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      ...
      <div className="relative z-10 max-w-md w-full">
        <div className="bg-white/10 rounded-3xl p-8 border border-white/20 shadow-2xl text-center">
          ...
          <p className="text-white/80 mb-2 leading-relaxed">Maaf, terjadi kesalahan yang tidak terduga. Silakan coba lagi atau kembali ke halaman utama.</p>

          {error.digest && <p className="text-white/60 text-xs mb-6 font-mono bg-black/20 p-2 rounded-lg">Error ID: {error.digest}</p>}
        ...
        <p className="text-center text-white/60 text-sm mt-6">Jika masalah terus berlanjut, silakan laporkan kepada administrator</p>
      </div>
    </div>
  );
}
